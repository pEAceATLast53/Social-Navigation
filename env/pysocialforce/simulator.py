...
"""
from env.pysocialforce.utils import DefaultConfig
from env.pysocialforce.scene import PedState, EnvState
from env.pysocialforce import forces
...
class Simulator:
    ...
    def __init__(self, state, radius, step_width, groups=None, obstacles=None, config_file=None):
        ...
        # initiate agents
        self.peds = PedState(state, groups, self.config, radius, step_width)
